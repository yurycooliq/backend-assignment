...
export class AuthController {
  ...
  @Post('register')
  @ApiResponse({ status: HttpStatus.CREATED, description: 'User registered and session created' })
  register(@Req() request: RequestWithContext, @Body() dto: AuthDto): Promise<unknown> {
  ...
  login(@Req() request: RequestWithContext, @Body() dto: AuthDto): Promise<unknown> {
